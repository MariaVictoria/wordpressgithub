...
function appointment_related_post() { 
 ...
 if( !$related_post_enable ) return; 
		...
		<i class="fa fa-calendar-o" aria-hidden="true"></i><a href="<?php the_permalink();?>"><?php echo esc_html(get_the_date());?></a>
		</div>
		<div class="blog-comment-sm"><i class="fa fa-comments-o" aria-hidden="true"></i><a href="<?php the_permalink(); ?>"><?php comments_number( '0', '1', '%' ); ?></a></div>
		</div>													
