...
$about = get_theme_mod( 'lead_corporate_about', 'disable' );
// Bail if the section is disabled.
if ( 'disable' === $about ) {
    return;
}

$sub_title    = get_theme_mod( 'lead_corporate_about_sub_title', __( 'About Us', 'lead-corporate') ) ;
$get_content = lead_corporate_get_section_content( 'about', $about, 1  );
?>
