...
$featured_courses = get_theme_mod( 'lead_corporate_featured_courses', 'disable' );
// Bail if the section is disabled.
if ( 'disable' === $featured_courses ) {
	return;
}
$featured_courses_count    = get_theme_mod( 'lead_corporate_featured_courses_count', 3 ) ;

$featured_courses_title    = get_theme_mod( 'lead_corporate_featured_courses_title', __( 'Working Process', 'lead-corporate') );
$featured_courses_subtitle    = get_theme_mod( 'lead_corporate_featured_courses_sub_title', __( 'How Does It Works', 'lead-corporate') );

$featured_courses_excerpt = get_theme_mod( 'lead_corporate_featured_courses_excerpt', 30 );

$get_content = lead_corporate_get_section_content( 'featured_courses', $featured_courses, $featured_courses_count  );
?>
