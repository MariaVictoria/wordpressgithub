...
$team = get_theme_mod( 'lead_corporate_team', 'disable' );
$subtitle   = get_theme_mod('lead_corporate_team_sub_title',__('Our Members','lead-corporate') );
$team_title   = get_theme_mod('lead_corporate_team_title', __('Here is Our Awesome Team','lead-corporate') );
// Bail if the section is disabled.
if ( 'disable' === $team ) {
	return;
}

$get_content = lead_corporate_get_section_content( 'team', $team, 3 );
            ...
            <article>
                <div class="team-item-wrapper">
                    ...
                    <header class="entry-header">
                        <span class="team-position"><?php echo esc_html(get_theme_mod('lead_corporate_team_position_'.($i+1))); ?></span>
