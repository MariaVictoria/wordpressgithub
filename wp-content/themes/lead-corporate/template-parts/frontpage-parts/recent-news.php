...
$recent_news = get_theme_mod( 'lead_corporate_recent_news', 'disable' );
// Bail if the section is disabled.
if ( 'disable' === $recent_news ) {
	return;
}

$recent_news_title    = get_theme_mod( 'lead_corporate_recent_news_title', __( 'Choose Your Perfect Plan', 'lead-corporate') );
$recent_news_subtitle    = get_theme_mod( 'lead_corporate_recent_news_sub_title', __( 'Recent News', 'lead-corporate') );

$get_content = lead_corporate_get_section_content( 'recent_news', $recent_news, 6 );
?>
                ...
                <div class="recent-news-item">
                    ...
                    <div class="entry-container">
                        ...
                        <div class="entry-meta aos_content" >
                            <?php lead_corporate_post_author() ;

                            lead_corporate_posted_on( $content['id'] ); ?>
                        </div><!-- .entry-meta -->
                        ...
                        <div class="read-more">
                            <a href="<?php echo esc_url( $content['url'] ); ?>" class="button"><?php echo esc_html( 'Learn More','lead-corporate' ); ?></a>
                        </div>
                    </div><!-- .entry-container -->
