...
$slider = get_theme_mod( 'lead_corporate_slider', 'disable' );
// Bail if the section is disabled.
if ( 'disable' === $slider ) {
	return;
}

$slider_btn    = get_theme_mod( 'lead_corporate_slider_button_label', __( 'Learn More', 'lead-corporate') );

$get_content = lead_corporate_get_section_content( 'slider', $slider, 3  );
?>
