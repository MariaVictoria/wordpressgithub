...
add_action( 'customize_controls_enqueue_scripts', function() {
	...
	wp_enqueue_script(
		'starhotel-customize-section-button',
...
function star_hotel_scripts() {
	...
	wp_enqueue_style('starhotel-editor-style',get_template_directory_uri().'/assets/css/editor-style.css');

	wp_enqueue_style('starhotel-main', get_template_directory_uri() . '/assets/css/main.css');

	wp_enqueue_style('starhotel-woo', get_template_directory_uri() . '/assets/css/woo.css');
	
	wp_enqueue_style( 'starhotel-style', get_stylesheet_uri() );
	...
	wp_enqueue_script('swiperelementbundle', get_template_directory_uri() . '/assets/js/swiper-element-bundle.js', array('jquery'), true);
	...
	wp_enqueue_script('starhotel-custom-js', get_template_directory_uri() . '/assets/js/theme.js', array('jquery'), false, true);

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'star_hotel_scripts' );
